<x-layout class="text-blue-600">
	<secton id="main-wrapper" class="max-w-5xl mx-auto flex flex-col">
		...
		<div id="contact-content" class="mx-5 my-10 pb-12 text-lg">
			...
			<br>
			<p>With our IT consulting services, we optimize your technology infrastructure, ensuring it aligns with your business goals and enhances overall performance. Our experienced consultants provide expert guidance and support to maximize the value of your technology investments.</p>
			<br>
			<p>At <strong>Dumavena</strong>, we pride ourselves on our attention to detail, creativity, and commitment to client satisfaction. We partner with you to understand your vision and deliver tailored solutions that help your business thrive.</p>
			<br>
			Join us on the journey to digital success. Contact us today and let's turn your online aspirations into reality.
		</div>
